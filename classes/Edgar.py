...
class Edgar:
  ...
  # search for 13F report and return query results
    ...
    query_13f_soup = BeautifulSoup(query_13f_resp.text, "html.parser")
  ...
  # fetch the 13f filing details and return the result
    ...
    doc_filing_soup = BeautifulSoup(doc_filing_pg.text, "html.parser")
  ...
  # fetch the report and return the result
    ...
    report = BeautifulSoup(report_resp.text, "html.parser")
    return report
